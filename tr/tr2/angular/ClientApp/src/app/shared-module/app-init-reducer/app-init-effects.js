...
var InitAppEffects = /** @class */ (function () {
    function InitAppEffects(actions$, categoryService) {
        var _this = this;
        ...
        //  );
        //}
        this.initCategories = this.actions$.pipe(effects_1.ofType('INIT_CATEGORIES_BEGIN'), operators_1.switchMap(function (initCategoriesBegin) {
